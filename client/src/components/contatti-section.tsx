          ...
          <div className="space-y-8">
            ...
            <div className="pt-8 border-t border-gray-200">
              ...
              <div className="flex flex-col space-y-2">
                ...
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/OrchestraIlPlettro/?locale=it_IT"
                  target="_blank"
                ...
                {/* YouTube */}
                <a
                  href="https://www.youtube.com/user/plettro82"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 text-white hover:text-gray-100 transition-colors"
                >
                  ...
                  <span className="font-medium text-charcoal">plettro82</span>
                </a>
